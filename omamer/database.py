...
class Database(object):
    ...
    @staticmethod
    def _convert_hog2gt(hog_off, hog2taxon2subtrees_leaves, hog_tab2, tax_tab, st, tax_id2tax_off, cprot_buff, sp_tab, prot_tab):
    ...
    def convert_hog2gt(
        self, hog_off, hog_tab, chog_buff, tax_tab, st, tax_id2tax_off, cprot_buff, sp_tab, prot_tab):
        '''
        ...
        hog2taxon2subtrees_leaves = traverse(
            hog_off, hog_tab, chog_buff, hog2taxon2subtrees_leaves, self._convert_hog2gt, None, self._convert_hog2gt,
