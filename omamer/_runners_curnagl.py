...
python ${{omamer_path}}omamer/_runners_curnagl.py ${{omamer_path}} parse_hogs ${{db_path}} ${{root_taxon}} ${{min_fam_size}} ${{logic}} ${{min_completeness}} ${{include_younger_fams}} ${{oma_path}} ${{overwrite}}
...
python ${{omamer_path}}omamer/_runners_curnagl.py ${{omamer_path}} suffix_array ${{db_path}} ${{root_taxon}} ${{min_fam_size}} ${{logic}} ${{min_completeness}} ${{include_younger_fams}} ${{reduced_alphabet}} ${{overwrite}}
...
python ${{omamer_path}}omamer/_runners_curnagl.py ${{omamer_path}} kmer_table ${{db_path}} ${{root_taxon}} ${{min_fam_size}} ${{logic}} ${{min_completeness}} ${{include_younger_fams}} ${{reduced_alphabet}} ${{k}} ${{hidden_taxa}} ${{overwrite}}
sstat -j ${{SLURM_JOBID}}.batch --format=MaxRSS
sacct -j ${{SLURM_JOBID}}.batch --format=elapsed""".format(mem, hour_nr, name, oe_path, oe_path))
...
python ${{omamer_path}}omamer/_runners_curnagl.py ${{omamer_path}} omamer_search ${{db_path}} ${{root_taxon}} ${{min_fam_size}} ${{logic}} ${{min_completeness}} ${{reduced_alphabet}} ${{k}} ${{query_sp}} ${{proteome_fn}} ${{store_hdf5}} ${{out_path}} ${{ref_taxon}} ${{overwrite}}
